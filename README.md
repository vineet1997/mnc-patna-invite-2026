...
A standalone, mobile-first digital invitation for Mukesh & Company’s annual multi-brand home-fashion conference in Patna.
...
- `components/SeasonBookHero.tsx` contains the swatch-book opening.
...
- `public/brands/` contains verified official brand assets.
- `public/og.png` is the dedicated social-sharing card.
